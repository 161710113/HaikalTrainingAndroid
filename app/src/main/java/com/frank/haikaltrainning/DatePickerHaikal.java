...
public class DatePickerHaikal extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_picker_haikal);
    ...
    private void settingTanggal() {
        new DatePickerDialog(DatePickerHaikal.this, d,
                dateAndTime.get(Calendar.YEAR),
                dateAndTime.get(Calendar.MONTH),
                dateAndTime.get(Calendar.DAY_OF_MONTH)).show();
    }
    private void setJam() {
        new TimePickerDialog(DatePickerHaikal.this, t,
